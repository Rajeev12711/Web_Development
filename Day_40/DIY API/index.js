...
app.get('/filter', (req, res)=>{
  ...
  const foundalljokes = jokes.filter((joke) => joke.jokeType === type);
  res.json(foundalljokes);
});
...
app.patch('/jokes/:id', (req, res) =>{
  ...
  const replacejoke ={
    id: id,
    jokesText : req.body.text || existingjoke.jokeText,
...
app.delete('/all', (req, res) =>{
  ...
  if (userKey == masterKey){
    ...
    res
    .status(400)
    .json({error:`You arenot authorised to perform this action.`});
  }
});
